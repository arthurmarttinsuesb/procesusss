...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Secretaria: {{ $secretaria->titulo }}</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <form method="POST" id="form">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" autocomplete="off" id="titulo" name="titulo" class="form-control" value="{{ $secretaria->titulo }}">
                                </div>
                                <div class="form-group">
                                    <strong>Sigla</strong>
                                    <input readonly type="text" autocomplete="off" id="sigla" name="sigla" class="form-control" value="{{ $secretaria->sigla }}">
                                </div>
                                <div class="form-group">
                                    <strong>Status</strong>
                                    <input readonly type="text" autocomplete="off" id="status" name="status" class="form-control" value="{{ $secretaria->status }}">
                                </div>
                            </div>
