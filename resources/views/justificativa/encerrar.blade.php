...
@section('htmlheader_title', 'Justificativa para Encerrar')
@section('contentheader_title', 'Justificativa para Encerrar')
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Justificativa para Encerrar</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item active">Justificativa para Encerrar</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    @endif
                    <div class="card-body">
                        <form method="POST" action="/processo/{{$processo_busca->id}}/encerrar" id="encerrar_form">
                            @csrf
                    ...
                    <div class="card-footer">
                        <button type="submit" form="encerrar_form" class="btn btn-info float-right" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i>
