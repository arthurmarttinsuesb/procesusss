          ...
          <div class="card">
             <div class="card-header">
                <div class="col-2 float-right">
                  <a href="{{ route('modelo_documento') }}" class="btn btn-block btn-outline-info "><i class="fa fa-list-alt"></i> Listar Modelos</a>
                </div>
              </div>
              <div class="card-body">
                  ...
                  <br><br>
                   <form method="POST" id="form_modelo" action="{{ route('adicionar_modelo') }}">
                   @csrf
