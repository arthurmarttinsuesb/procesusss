          ...
          <div class="card">
             <div class="card-header">
                <div class="col-2 float-right">
                  <a href="{{ route('listar_modelo') }}" class="btn btn-block btn-outline-info "><i class="fa fa-list-alt"></i> Listar Modelos</a>
                </div>
              </div>
              <div class="card-body">
                  ...
                  @if($modelo=="novo")
                      <form method="POST" id="form">
                            ...
                            <div class="card-footer">
                                <button type="button" class="btn btn-info float-right salvar" 
