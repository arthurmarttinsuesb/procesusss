...
<div class="login-logo">
    <a href="{{ url('/home') }}"><img src="{{url('/img/logo-processus.png')}}" alt="Processus"
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="date" class="form-control @error('nascimento') is-invalid @enderror" name="nascimento"
                        id="nascimento" maxlength="10" value="{{ old('nascimento') }}"
                        placeholder="Data de Nascimento" />
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-2 sexo hidden">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control hidden" placeholder="Informe o seu gênero" name="genero"
                ...
                <div class="form-group col-md-3">
                    <div class="form-group cpf">
                        ...
                        <input type="text" class="form-control @error('cpf_cnpj') is-invalid @enderror" name="cpf_cnpj"
                            id="cpf_cnpj" placeholder="Identificação" value="{{ old('cpf_cnpj') }}" />
                    </div>
                </div>
                <div class="form-group col-md-2">
                    <div class="form-group cpf">
                        ...
                        <input type="text" class="form-control @error('telefone') is-invalid @enderror" name="telefone"
                            id="telefone" placeholder="(dd) 00000-000" data-inputmask='"mask":"(99)99999-9999"'
                            value="{{ old('telefone') }}" data-mask />
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select id="cidade" name='cidade'
                        class="form-control select2 @error('cidade') is-invalid @enderror">
                        <option value="">Selecione</option>
                    </select>
                </div>
                <div class="form-group col-md-4">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control @error('bairro') is-invalid @enderror" name="bairro"
                        id="bairro" placeholder="Bairro" value="{{old('bairro')}}" />
                </div>
                <div class="form-group col-md-2">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control @error('email') is-invalid @enderror" name="email"
                            id="email" placeholder="email@exemplo.com" value="{{old('email')}}" />
                    </div>
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror"
                        placeholder="Repetir a Senha de Acesso" name="password_confirmation" />
                </div>
            </div>
