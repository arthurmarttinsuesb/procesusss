...
class ConsultarDocumentoController extends Controller
{
    /**
    ...
    public function list($numeroProcesso)
    {

        $processo = Processo::where('numero', $numeroProcesso)->with('documento_tramites')->get();
