 <?php $__env->startSection('htmlheader_title', 'Meu Modelo'); ?>
 <?php $__env->startSection('contentheader_title', 'Meu Modelo'); ?>
      ...
      <div class="row">
        <div class="col-12">
           ...
           <div class="card">
              ...
              <form  method="POST" id="form" action="/meu-modelo">
                 <?php echo csrf_field(); ?>
                <div class="card-body">
...
unset($__errorArgs, $__bag); ?>" name='conteudo' id='conteudo' placeholder="Place some text here"
                                    style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px; font-weight: 700;"><?php echo e(old('conteudo')); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/processus/resources/views/MeuModelo/create.blade.php ENDPATH**/ ?>