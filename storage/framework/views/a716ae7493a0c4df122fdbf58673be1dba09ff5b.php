          ...
          <div class="card">
            <div class="card-header">
                <div class="float-right">
                    <a href="<?php echo e(URL::to('meu-modelo/create')); ?>" class="btn btn-block btn-outline-info"><i class="fa fa-plus"></i> Adicionar Modelo</a>
                </div>
            </div>
            <!-- /.card-header -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/processus/resources/views/MeuModelo/index.blade.php ENDPATH**/ ?>