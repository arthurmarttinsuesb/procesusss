        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <?php endif; ?>
                    <div class="card-body">
                        <form method="POST" action="/conta/<?php echo e($usuario->id); ?>" id="change-password" >
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                                ...
                                <div class="row">
                                    <div class="form-group col-4">
                                        ...
                                        <input type="password" autocomplete="off" id="password_current" name="password_current" class="form-control <?php $__errorArgs = ['password_current'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('password_current')); ?>"  minlength="8" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <input type="password" autocomplete="off" id="password" name="password" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('password')); ?>"  minlength="8" required>
                                        <?php $__errorArgs = ['senha'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/processus/resources/views/minhaConta/editSenha.blade.php ENDPATH**/ ?>