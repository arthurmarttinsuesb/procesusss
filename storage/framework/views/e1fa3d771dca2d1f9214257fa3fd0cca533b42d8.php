...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Alterar Modelo Documento</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="row">
        <div class="col-12">
           ...
           <div class="card">
              ...
              <?php endif; ?>
              <form  method="POST" id="form" action="/modelo-documento/<?php echo e($modelo->id); ?>">
                 <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/processus/resources/views/modeloDocumento/edit.blade.php ENDPATH**/ ?>