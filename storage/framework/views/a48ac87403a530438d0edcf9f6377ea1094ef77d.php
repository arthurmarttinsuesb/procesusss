                ...
                <div class="card">
                    <div class="card-header">
                            <div class=" float-right">
                                <a href="<?php echo e(URL::to('setor/create')); ?>" class="btn btn-block btn-outline-info"><i class="fa fa-plus"></i> Adicionar Setor</a>
...
<script src="<?php echo e(asset('js/setor.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/processus/resources/views/setor/index.blade.php ENDPATH**/ ?>